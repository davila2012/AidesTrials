...
The following is a bar chart of South Carolina females who were tested in the clinical trials. 
```{r}
barchartGC(ScarolinaFtable, type="percent")
```

The following is a bar chart of South Carolina males who were tested in the clinical trials. 
```{r}
barchartGC(ScarolinaMtable, type="percent")
```
